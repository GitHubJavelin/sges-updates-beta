...
function AircraftParameters() -- don't remove the function
    ...
    elseif PLANE_ICAO == "B732" then BeltLoaderFwdPosition = 6.1	SecondStairsFwdPosition = -9.3	custom_fuel_finalX = -15 	custom_fuel_finalY = 0 	custom_fuel_pump_finalX = 13 	custom_fuel_pump_finalY = -4
