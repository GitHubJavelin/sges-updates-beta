...
function AircraftParameters() -- don't remove the function
    ...
    elseif PLANE_ICAO == "B732" then BeltLoaderFwdPosition = 6.1	SecondStairsFwdPosition = -8.7 custom_fuel_finalX = -15 custom_fuel_finalY = 0 custom_fuel_pump_finalX = 13 custom_fuel_pump_finalY = -4
    ...
    elseif PLANE_ICAO == "B742" then BeltLoaderFwdPosition = 18.6 	SecondStairsFwdPosition = 13.2		airstart_unit_factor = 21	BeltLoaderRearPosition = -13 sges_refuel_port_longitudinal = 44 sges_refuel_port_elev = 4	custom_fuel_pump_finalX = 18.5 custom_fuel_pump_finalY = -1.5 custom_fuel_finalX = -26 custom_fuel_finalY = -5 airstart_unit_factor = 22.5
    ...
    elseif PLANE_ICAO == "B773" then BeltLoaderFwdPosition = 23.3 BeltLoaderRearPosition = -17.3 airstart_unit_factor = 24 SecondStairsFwdPosition = -24.7 custom_fuel_finalX = -15 custom_fuel_finalY = 0 custom_fuel_pump_finalX = 15.5 custom_fuel_pump_finalY = 0.5
    elseif PLANE_ICAO == "B77W" then BeltLoaderFwdPosition = 23.3 BeltLoaderRearPosition = -17.3 airstart_unit_factor = 24 SecondStairsFwdPosition = -24.7 custom_fuel_finalX = -15 custom_fuel_finalY = 0 custom_fuel_pump_finalX = 15.5 custom_fuel_pump_finalY = 0.5 UseXplane1220Chocks = true UseXplane1220Chocks_specific = true
...
custom_fuel_pump_finalY = 1.5 -- SecondStairsFwdPosition = -5.9
    ...
    elseif PLANE_ICAO == "CL60" then BeltLoaderFwdPosition = -5 targetDoorX_alternate = 0.001 targetDoorZ_alternate = 0 targetDoorH_alternate = 2.0 UseXplane1220Chocks = true UseXplane1220Chocks_specific = true
    ...
    elseif PLANE_ICAO == "L188" then BeltLoaderFwdPosition = 7.50	airstart_unit_factor = 19.4
    ...
    elseif string.match(AIRCRAFT_PATH, "Nieuport XVII") then BeltLoaderFwdPosition = -3
    ...
    elseif get("sim/aircraft/parts/acf_gear_znodef") >= -3 then
		...
		print("[Ground Equipment " .. version_text_SGES .. "] Small aircraft not customized. Applying smaller ground services.")
		-- automatically recognize small aircraft and apply GA services.
    else BeltLoaderFwdPosition = 10 SecondStairsFwdPosition = -30
		print("[Ground Equipment " .. version_text_SGES .. "] Aircraft not customized. Applying regular ground services.")
    ...
    elseif PLANE_ICAO == "B773" or PLANE_ICAO == "B77W" then vertical_door_position = -2.1 deltaDoorX = 8.7
    ...
    elseif string.match(AIRCRAFT_PATH, "AS365") then vertical_door_position = -4 deltaDoorX = 9 			targetDoorX_alternate = 0.1 targetDoorZ_alternate = -3.6 	targetDoorH_alternate = 0.8 -- Dauphin
    ...
    elseif PLANE_ICAO == "B732" then vertical_door_position2 = -2.8 deltaDoorX2 = 7.5 sges_gs_plane_head_correction2 = -6.8
    ...
    elseif PLANE_ICAO == "B773" or PLANE_ICAO == "B77W" then vertical_door_position2 = -2.2 deltaDoorX2 = 8.75  sges_gs_plane_head_correction2 = -0.2 longitudinal_factor3 = 18.3 height_factor3 = 0 lateral_factor3 = 0.15
    elseif PLANE_ICAO == "B77W" then vertical_door_position2 = -3.0 deltaDoorX2 = 9.9	sges_gs_plane_head_correction2 = -0.2
    ...
    elseif (PLANE_ICAO == "B772" or PLANE_ICAO == "B77L" or PLANE_ICAO == "B773" or PLANE_ICAO == "B77W") and string.find(SGES_Author,"FlightFactor") then dataref_to_open_the_door = "1-sim/anim/doorL1"   	index_to_open_the_door = 0 target_to_open_the_door = 1 index_to_open_the_second_door = 5  -- FF/STS 767
